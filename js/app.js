...
class Hero {
  ...
  // Draw hero sprite on current x and y coordinate
  render() {
    ctx.drawImage(Resources.get(this.sprite), this.x, this.y);
  }
  ...
  update() {
    ...
    // Win condition check here...
      // Did player x and y reach finish line? water tile
    if(this.y === 55) {
      this.victory = true;
...
const bug3 = new Enemy(-101, 166, Math.random(Math.random() * (600-215+1) + 215));
const allEnemies = [];
